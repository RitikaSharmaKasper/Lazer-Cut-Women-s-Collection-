...
const AddProduct = () => {
  ...
  const Tags = ["Bestseller", "New Arrival", "Trending", "Premium"];
  ...
  const material = ["Cotton", "Silk", "Linen", "Polyester", "Denim"];
...
// ─── Replace these constants near the top of your component ───
...
const variantsType = ["Regular Fit", "Slim Fit", "Oversized", "Relaxed Fit", "Bodycon"];

// ─── Replace SKU generation — change -ART- to -WS- ───

// In generatedSKU():
const newSKU = `${prefix}-WS-${randomNum}`;

// In handleChange() where SKU is auto-generated from title:
const sku = `${initials}-WS-${randomNum}`;
                  ...
                  <table className="w-full min-w-[1200px] text-sm">
                    <thead className="bg-[#F5F8FA]">
                      <tr className="">
                        ...
                        <th className="px-3 py-2 text-left">Size / Fabric</th>

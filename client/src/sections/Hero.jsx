...
const CATEGORY_SLIDES = [
{
  ...
  },
  {
    ...
    path: "/products/Jeans%20%26%20Pants"
  },
  {
    id: 4,
        ...
        <div className="w-full min-h-max max-md:py-4 md:min-h-[500px] flex flex-col md:flex-row items-center justify-center lg:justify-between sm:rounded-lg border overflow-hidden bg-[#D5E5F5] shadow-sm">
          ...
          <div className="flex flex-col gap-4 px-4 md:px-6 lg:px-8 text-center md:text-left">
            <h1 className="font-imprima text-[24px] sm:text-3xl md:text-[2.5rem] lg:text-[3rem] tracking-tight font-light lg:w-[400px] !leading-[1.2]">
              Aura - Elegance Redefined
            </h1>
            <p className="text-[14px] sm:text-[18px] text-gray-800 lg:w-[400px]">
              Discover the latest trends and exquisite collections in women's fashion.
            </p>
            <Link
              ...
              <SwiperSlide key={product.uuid}>
                ...
                >
                  <img
                    className="h-full w-full object-cover mx-auto flex-shrink-0"
                    src={
                      product?.variants?.[0]?.variantImage?.[0] || {mainimg}
                    }
...
{/* Right Section - Manual Carousel */}
        <div className="relative group w-full sm:min-w-[350px] lg:!w-[400px] xl:min-w-[420px] overflow-hidden shadow-sm h-[300px] sm:h-[400px] md:h-[500px] sm:rounded-lg max-sm:mx-8">
              ...
              <SwiperSlide key={slide.id}>
                ...
                >
                  <img
                    ...
                    alt={slide.category}
                  />
                  <span className="absolute text-sm sm:text-lg font-medium bottom-6 left-6 bg-[#D5E5F5]/90 backdrop-blur-sm px-5 py-2 rounded-lg border border-[#1C3753] shadow-lg flex items-center gap-2">
                    {slide.category}
                    <ArrowRight className="w-5 h-5" />
                  </span>
                </Link>
          ...
          <button className="swiper-prev absolute group-hover:flex hidden items-center justify-center top-1/2 -translate-y-1/2 left-4 z-10 bg-white/50 hover:bg-white p-2 rounded-full transition-all">
            <ChevronLeft size={30} className="text-[#1C3753]" />
          </button>
          <button className="swiper-next absolute group-hover:flex hidden items-center justify-center top-1/2 -translate-y-1/2 right-4 z-10 bg-white/50 hover:bg-white p-2 rounded-full transition-all">
            <ChevronRight size={30} className="text-[#1C3753]" />
          </button>
        </div>
